...
Route::get('/absensi/', 'AbsensiController@index')->name('absen');
...
Route::post('/siswa/submit-absen/', 'SiswaController@submitAbsen')->name('submit_absen');
...
Route::get('/u/dashboard', 'UserController@index')->middleware(['siswa',])->name("user-dashboard");

Route::get('logout', 'AuthController@logout');
Route::get('admin', 'AuthController@showForm');
Route::get('Guru', 'AuthController@showForm');
